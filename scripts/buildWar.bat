...
"C:\Program Files (x86)\Microsoft Visual Studio\2019\BuildTools\MSBuild\Current\Bin\msbuild.exe" buildWar.msbuild /p:ProjectName=%ProjectName%;KBPath=%KBPath%;ObjectNames=%ObjectNames%
